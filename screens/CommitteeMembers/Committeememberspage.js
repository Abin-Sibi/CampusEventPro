...
return (
  <View style={styles.eventmemberspage}>
    ...
    >{`28   FEB  2024
Sunday`}</Text>
<TouchableOpacity onPress={()=>{navigation.navigate('Eventmembernotification')}}>
  <Image
    ...
    />
    <TouchableOpacity onPress={()=>{navigation.navigate('Committeemembercompletedtask',{taskData})}}>
      <Image
      style={styles.okIcon}
      contentFit="cover"
    ...
    <TouchableOpacity onPress={()=>{navigation.navigate('Committeememberpendingtask',{taskData})}}>
      <Image
