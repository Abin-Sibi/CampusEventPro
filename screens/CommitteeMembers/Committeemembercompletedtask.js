...
const Committeemembercompletedtask = () => {
  return (
    <View style={styles.committeemembercompletedtask}>
      <View style={styles.committeemembercompletedtaskChild} />
      <View
        style={[
          styles.committeemembercompletedtaskItem,
          styles.committeemembercompletedtaskShadowBox,
        ]}
      />
      <View
        style={[
          styles.committeemembercompletedtaskInner,
          styles.committeemembercompletedtaskShadowBox,
        ]}
      />
...
const styles = StyleSheet.create({
  committeemembercompletedtaskShadowBox: {
    height: 233,
    width: 292,
  ...
  committeemembercompletedtaskChild: {
    top: 140,
    left: 29,
  ...
  committeemembercompletedtaskItem: {
    top: 465,
    left: 50,
  },
  committeemembercompletedtaskInner: {
    top: 193,
    left: 51,
  },
  taskNameDue: {
