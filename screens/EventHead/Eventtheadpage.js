...
<TouchableOpacity onPress={()=>{navigation.navigate('Eventheadaddtask',{eventdata})}}>
      <Image
      ...
      <TouchableOpacity onPress={()=>{navigation.navigate('Eventheadteammembers',{eventdata})}}>
        <Image
      ...
      <TouchableOpacity onPress={()=>{navigation.navigate('Eventtheadcompletedtask',{eventdata})}}>
        <Image
      ...
      <TouchableOpacity onPress={()=>{navigation.navigate('Eventheadceventmeberdetails',{eventdata})}}>
        <Image
      ...
      <TouchableOpacity onPress={()=>{navigation.navigate('Eventheadpendingtask',{eventdata})}}>
        <Image
