...
const Eventmembergeneratereports = () => {
    const navigation = useNavigation();
  return (
    <View style={styles.eventmembergeneratereports}>
      ...
      />
      <TouchableOpacity onPress={()=>{navigation.navigate('EventmemberGeneratedReports')}}>
        <Image
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../../assets/Calendar.png")}EventmembergeneratereportsEventmembergeneratereports
      />
      <Image
...
`}</Text>
      <View
        style={[
          styles.eventmembergeneratereportsChild,
...
const styles = StyleSheet.create({
  ...
  eventmembergeneratereportsChild: {
    top: 682,
...
export default Eventmembergeneratereports;
