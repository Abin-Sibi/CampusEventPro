...
const Committeeheadcompletedtask = () => {
  return (
    <View style={styles.committeeheadcompletedtask}>
      <View style={styles.committeeheadcompletedtaskChild} />
      <View
        style={[
          styles.committeeheadcompletedtaskItem,
          styles.committeeheadcompletedtaskShadowBox,
        ]}
      />
      <View
        style={[
          styles.committeeheadcompletedtaskInner,
          styles.committeeheadcompletedtaskShadowBox,
        ]}
      />
...
const styles = StyleSheet.create({
  committeeheadcompletedtaskShadowBox: {
    height: 233,
    width: 292,
  ...
  committeeheadcompletedtaskChild: {
    top: 140,
    left: 29,
  ...
  committeeheadcompletedtaskItem: {
    top: 465,
    left: 50,
  },
  committeeheadcompletedtaskInner: {
    top: 193,
    left: 51,
  },
  taskNameDue: {
...
export default Committeeheadcompletedtask;
